# Paper Offshoots — wissenschaftliche Nebenstränge aus der Gesamtarbeit

**Status:** research planning only  
**Authority:** proposal / programme planning  
**Evidenzrolle:** keine DATA, keine EVID, keine automatische Claim-Promotion

Edition 1.8 ist der gemeinsame Kontext des Forschungsprogramms. Dieses Verzeichnis benennt kleinere, disziplinär enger prüfbare Publikationsstränge, die aus der Gesamtarbeit hervorgehen können. Die Einträge sind **keine fertigen Paper** und keine Zusage, dass jeder Strang veröffentlicht wird. Ein Strang wird erst zu einer eigenständigen Arbeit, wenn Forschungsfrage, Quellenbasis, Methoden-/Analysevertrag, Claim-Grenze und Reviewstatus für diesen Strang separat geklärt sind.

| ID | Arbeitstitel | Primärer Anschluss | Zielgruppe | Aktueller Status | Harte Grenze |
| --- | --- | --- | --- | --- | --- |
...
| **PO-002** | Digitaler Sinn: gelernte Informationsnutzung und kontrollierte periphere Werkzeuge in SNN-Architekturen | `RQ-GW-002`, `RQ-GW-004`, `RQ-GW-006`, `RQ-GW-CODEC-001`, Gateway-/Neural-Symbiosis-Programm | Informatik / Systems / Neuro-AI | `concept_protocol_required` | Gateway-Erreichbarkeit ist nicht gleich gelerntem Werkzeuggebrauch; Quellentransfer, Query als Handlung, Modalitätsrouting und Binding müssen separat geprüft werden. |
...
Ein Nebenstrang wird nur weiterentwickelt, wenn er mindestens eine klar abgrenzbare Forschungsfrage besitzt und gegenüber der Gesamtarbeit **kleiner, prüfbarer und zitierbarer** wird. Reines Umverpacken derselben Aussagen in mehrere Texte ist kein wissenschaftlicher Fortschritt.

Vor einer Einreichung muss jeder Strang mindestens dokumentieren:

1. kanonische RQ/Hypothese oder explizit argumentative Fragestellung;
2. verwendete DATA/EVID-Quellen mit Provenienz;
3. primäre Claim-Grenze und verbotene Überinterpretationen;
4. passende Kontroll-/Vergleichsbedingungen bei empirischen Arbeiten;
5. Prior-Art- und Quellenprüfung;
6. Human Review und, wo relevant, unabhängige Replikation;
7. Verhältnis zur Edition 1.8: übernommen, neu getestet oder nur kontextualisiert.
