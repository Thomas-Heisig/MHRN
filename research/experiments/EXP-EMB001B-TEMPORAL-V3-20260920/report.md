# EXP-EMB001B-TEMPORAL-V3-20260920
...
Source freeze: 074adbc9a9182ddf9b7ec0de338fd2f28b26c8c9
Runs: 100
Paired seeds: 20
Ticks per run: 1000
...

{
  ...
  "yoked_replay_shift100": {
    "sensor_path_mean_abs_q_rad": 0.47664133639526274,
    "sensor_path_rms_q_rad": 0.5340010519132699,
    "tracking_rmse_rad": 0.4088772173462389
  },
  "yoked_replay_shift20": {
    "sensor_path_mean_abs_q_rad": 0.2571758749517066,
    "sensor_path_rms_q_rad": 0.29726186294030993,
    "tracking_rmse_rad": 0.23226267676691714
  }
}
...
[
  {
    ...
    "fraction_closed_loop_lower": 0.0,
  ...
  },
  {
    ...
    "maximum_difference": 0.10659356837262274,
    "mean_difference": 0.07340954309050016,
    "median_difference": 0.0677638928228041,
    "metric": "tracking_rmse_rad",
    "minimum_difference": 0.03352829649882946,
    "n_paired_seeds": 20,
    "p_value": null,
    "reference": "closed_loop",
    "ties": 0
  },
  {
    ...
    "differences_control_minus_closed_loop": [
      ...
      0.07640340307312415,
      0.06950834190065364,
      0.060887863799512526,
      0.07682086796073284,
      0.06226353372627555,
      0.05954719364678332
    ],
    "fraction_closed_loop_lower": 1.0,
    "maximum_difference": 0.07767525364843145,
    "mean_difference": 0.06443360480961387,
    "median_difference": 0.06171133076695287,
    "metric": "sensor_path_rms_q_rad",
    "minimum_difference": 0.04553907038681748,
    "n_paired_seeds": 20,
    "p_value": null,
    "reference": "closed_loop",
    "ties": 0
  },
  {
    ...
    "fraction_closed_loop_lower": 1.0,
    "maximum_difference": 0.2602513399993477,
    "mean_difference": 0.2500240836698219,
    "median_difference": 0.24911550911751246,
    "metric": "tracking_rmse_rad",
    "minimum_difference": 0.23838470056894118,
    "n_paired_seeds": 20,
    "p_value": null,
    "reference": "closed_loop",
    "ties": 0
  },
  {
    ...
    "fraction_closed_loop_lower": 1.0,
    "maximum_difference": 0.3136334149353685,
    "mean_difference": 0.3011727937825738,
    "median_difference": 0.3023921838868856,
    "metric": "sensor_path_rms_q_rad",
    "minimum_difference": 0.2881491236846382,
    "n_paired_seeds": 20,
    "p_value": null,
    "reference": "closed_loop",
    "ties": 0
...
This is prospective exploratory synthetic DATA testing temporal alignment within the scoped H-EMB-001-B programme. It is not confirmatory EVID, not independent replication, not evidence of learned body schema, autonomy, consciousness, biological equivalence, real-device transfer, or 5D superiority. Human Review remains required.
