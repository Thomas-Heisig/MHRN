# EXP-BATCH-20260914074039-26: Wissenschaftliche Zusammenfassung
...
- Protokoll: `structural_efficiency_boundary_v1`
- Durchlaeufe: `3`
- Seeds: `[101, 102, 103]`
...
- Titel: Experiment workflow: structural_efficiency_boundary_v1
...
- Git dirty: `True`
- Runtime: `0.053931200003717095` s
...
AIRR-Fehler: `LLM must not generate quantitative statistics: statistics`. Die deterministische Datenauswertung oben bleibt davon unberuehrt.

## 9. Artefakte

- [analysis/ai_packet.json](analysis/ai_packet.json)
- [analysis/ai_packet_digest.json](analysis/ai_packet_digest.json)
- [analysis/AIAR-critical_reviewer-20260914082125135775-9a40602a.json](analysis/AIAR-critical_reviewer-20260914082125135775-9a40602a.json)
- [analysis/AIAR-scientific_analyst-20260914082040337719-9a40602a.json](analysis/AIAR-scientific_analyst-20260914082040337719-9a40602a.json)
