# EXP-BATCH-20260914074039-75: Experiment workflow: connectome_topology_screen_v1

## Forschungszuordnung
Forschungsfrage: `RQ-CONN-002`
Hypothese: `H-CONN-002-A`
Aufgeloester Runner: `run_connectome_topology`

## Protokoll und Einstellungen
Protokoll: `connectome_topology_screen_v1`
Angeforderte Mindest-Ticks: `1000`
Seeds: `101, 102, 103`
Tick-Vertrag: `{"reason": "Tick contract violated: runner run_connectome_topology did not execute at least 1000 ticks in every run.", "requested_ticks": 1000, "retained_failed_observations": true, "status": "VIOLATED"}`

## Bedingungen
Registered protocol conditions
Runs: 12; Dauer: 0.236284 s
