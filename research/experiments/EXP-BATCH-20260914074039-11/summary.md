# EXP-BATCH-20260914074039-11: Wissenschaftliche Zusammenfassung
...
- Protokoll: `stdp_pair_timing_registered_v1`
- Durchlaeufe: `3`
- Seeds: `[101, 102, 103]`
...
- Beobachtete Conditions: `registered_pair_timing_curve`

`DIRECT_MATCH` bezeichnet einen gezielten RQ-spezifischen Lauf. `CONTAINS_MATCH` bedeutet, dass die passende Teilstudie innerhalb einer Gesamtsuite enthalten ist; nur diese Teilstudie ist primaer fuer die registrierte RQ auszuwerten. `MISMATCH` blockiert die Nutzung als Evidenz fuer die registrierte Forschungsfrage, auch wenn die technische Ausfuehrung fehlerfrei war.

## 3. Ausfuehrungsparameter

- Titel: Experiment workflow: stdp_pair_timing_registered_v1
...
- Git dirty: `True`
- Runtime: `0.047335200011730194` s
...
| --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| registered_pair_timing_curve | 3 | 101,102,103 | — | — | — | — | — | — |

## 6. Einzelne Läufe

| Seed | Condition | Ticks | Spikes | Syn. events | Aktivierte Neuronen | Recurrent events | Depth | Runtime error |
| ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 101 | registered_pair_timing_curve | — | — | — | — | — | — | — |
| 102 | registered_pair_timing_curve | — | — | — | — | — | — | — |
| 103 | registered_pair_timing_curve | — | — | — | — | — | — | — |
...
- [analysis/AIAR-critical_reviewer-20260914075909797175-e26c87cd.json](analysis/AIAR-critical_reviewer-20260914075909797175-e26c87cd.json)
- [analysis/AIAR-scientific_analyst-20260914075815249134-e26c87cd.json](analysis/AIAR-scientific_analyst-20260914075815249134-e26c87cd.json)
- [analysis/AIAR-scientific_writer-20260914080003276191-e26c87cd.json](analysis/AIAR-scientific_writer-20260914080003276191-e26c87cd.json)
- [analysis/statistics.json](analysis/statistics.json)
- [DATA/current_run.json](DATA/current_run.json)
- [DATA/raw/run-0000-registered_pair_timing_curve-seed-101.json.gz](DATA/raw/run-0000-registered_pair_timing_curve-seed-101.json.gz)
- [DATA/raw/run-0001-registered_pair_timing_curve-seed-102.json.gz](DATA/raw/run-0001-registered_pair_timing_curve-seed-102.json.gz)
- [DATA/raw/run-0002-registered_pair_timing_curve-seed-103.json.gz](DATA/raw/run-0002-registered_pair_timing_curve-seed-103.json.gz)
