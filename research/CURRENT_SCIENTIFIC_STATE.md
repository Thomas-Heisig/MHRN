...
Die Quellprovenienz ist inzwischen konkret gebunden: `CL-002-EVID` verweist auf das human-reviewte `EVID.json` mit SHA-256 `c7b1124256fd8018839a8c5c29b30493b68d16bc223d0a3258bcbaca55b1752e`; `CL-003-DATA` verweist auf `results.json` mit SHA-256 `4e74021c0ef838371a3a01061ae1c2dcebb2031b54c15c6169e38c1972d06290`. Beide Sources sind im Proposal als `VERIFIED` markiert. Vor einer Ausführung bleiben Seed-/Taskplan, Analysevertrag, Ausführungsautorisation und Freeze vollständig zu binden. Approval ist keine Ausführung, DATA oder EVID.
