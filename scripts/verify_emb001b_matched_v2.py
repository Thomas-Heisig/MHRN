#!/usr/bin/env python3
"""Verify persisted DATA for EXP-EMB001B-MATCHED-V2-20260920."""
...
def main() -> int:
    ...
    assert manifest["protocol"] == "embodied_closed_loop_matched_disturbance_v2"
    ...
    assert len(seeds) == 20
    assert conditions == {"closed_loop", "yoked_replay", "feedback_absent"}
    ...
    for seed in seeds:
        ...
        assert (
            rows[(seed, "yoked_replay")]["donor_tape_sha256"]
