#!/usr/bin/env python3
"""Verify EXP-EMB002A-PROPRIOCEPTION-V3-20260920."""
...
EXP_ID = "EXP-EMB002A-PROPRIOCEPTION-V3-20260920"
OUT = ROOT / "research/experiments" / EXP_ID
PREREG = ROOT / "research/preregistrations/PREREG-EMB002A-PROPRIOCEPTION-DIRECT-V3.json"
...
def main() -> int:
    ...
    assert manifest["protocol"] == "embodied_proprioception_direct_v3"
